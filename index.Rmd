...
- Cleaned up filenames available here:
  - https://app.globus.org/file-manager?origin_id=56569ec1-af41-4745-a8d1-8514231c7a6d&origin_path=%2Fproject%2Fhpcroot%2Fcsul%2F (download to your project with Globus)
  - https://m-7cdc74.a78b8.36fe.data.globus.org/project/hpcroot/csul/symphonie_fantastique.tar (download locally)
...
## Makeflow file
- Here's a snippet of our Makeflow file:
```{r,engine='bash',eval=FALSE}
