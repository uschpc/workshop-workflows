...
def main():
    ...
    python_command1='python3 '+rosa_path+ ' -f {flac_file}  -i {start_time} -o {outdir}'
    ...
    with open(makeflow_dir+'/'+song_name+".makeflow", "w") as makefile:
        ...
        for task_no in range(max_time):
            ...
            makefile.write("\t"+python_command1.format(flac_file=song_file,start_time=task_no,outdir=output_files_dir) + "\n")
